...
ctrlSetText [3003, ""];
lbClear _units;
_units lbAdd format["Lakeside Medical Team"];
_units lbAdd format["Lakeside Poilce Department"];
_units lbAdd format["The GODS"];
if((__GETC__(life_adminlevel) > 3)) then
{
	_units lbAdd format["The people od Lakeside(Everyone)"];
};
{
