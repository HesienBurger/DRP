...
_text = format["<br/><t color='#C5B6B5' size='1.8' align='center'>Welcome %1 to DefianceLife!</t><br/><br/>",ProfileName];  
...
_role1 = "Welcome to DefianceLife";
_role1names = ["Name : "];       //Add your texts here!
_role2 = "Always be on TS";
_role2names = ["Address : "]; // Add your TS IP here
_role3 = "Rules";
