...
switch(_shop) do
{
		...
		case "cop_lscpl":
        {
                switch(true) do
                {
                        ...
                        default
                        {
                                ["Lakeside Corporal Shop",
                                        [
											["RH_sbr9","SBR9 SMG",5000],
											["RH_32Rnd_9mm_M822","SBR9 32 Rnd",50],
											["optic_Aco","SBR9 Cobra Scope",50],
											["RH_g19",nil,500],
											["RH_17Rnd_9x19_g17",nil,50],                    
											["Taser_26",nil,1],
											["26_cartridge",nil,1]
        ...
        {	
                switch(true) do
                {
                        ...
                        default
                        {
                                ["Lakeside Lieutenant Weapon Shop",
                                        [
											["RH_M16A3",nil,7000],
											["RH_30Rnd_556x45_M855A1",nil,250],
											["RH_M16A4",nil,8000],
											["RH_30Rnd_556x45_M855A1",nil,300],
											["RH_reflex",nil,50],
											["optic_Arco",nil,100],
											["RH_M4m",nil,9000],
		...
		case "cop_fbi":
        {
                switch(true) do
                {
                        case (playerSide != west): {"You are not Part of FBI!"};
                        case (__GETC__(life_coplevel) < 5): {" You are not Part of FBI"};
                        default
                        {
        ...
        {	
                switch(true) do
                {
                        case (playerSide != west): {"You are not a S.E.R.T Member!"};
                        case (__GETC__(life_coplevel) < 6): {"You are apart of S.E.R.T!"};
                        default
                        {
                                ["Lakeside S.E.R.T Weapon Shop",
                                        [
