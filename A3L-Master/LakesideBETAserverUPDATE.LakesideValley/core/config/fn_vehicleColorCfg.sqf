...
switch (_vehicle) do
{
	...
	case "ivory_wrx" :
	{
		switch (_index) do
		{
			...
			case 8:  {_color = "Teal";};
			case 9:  {_color = "White";};
			case 10: {_color = "RedBlack";};
			case 11: {_color = "Camo";};
			case 12: {_color = "Nyan";};
			case 13: {_color = "BlackGray";};
			case 14: {_color = "RPD";};
			case 15: {_color = "Monster";};
			case 16: {_color = "Graystripe";};
			case 17: {_color = "Candy";};
			case 18: {_color = "SportOrange";};
			case 19: {_color = "S.E.R.T";};
			case 20: {_color = "PD";};
		};
	};
	...
	case "IVORY_REV": {
		...
		[
			...
			[_pathpolice + "Lambo.paa","med"],
			["textures/medic/Lambo.paa","med"]
		];
	};
	...
	case "O_Truck_02_covered_F":
	{
		_ret =
		[
			["textures\medic\cdc_front_0.paa","med","textures\medic\cdc_rear_1.paa"]
		];
	};
