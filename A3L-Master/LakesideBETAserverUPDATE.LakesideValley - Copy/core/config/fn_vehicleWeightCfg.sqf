...
switch (_className) do
{
	...
	//Defiance custom cars
	
	case "defiance_ivceco_black": {770};
	case "defiance_ivceco_blue": {770};
	case "defiance_ivceco_grey": {770};
	case "defiance_ivceco_orange": {770};
	case "defiance_ivceco_pink": {770};
	case "defiance_ivceco_purple": {770};
	case "defiance_ivceco_red": {770};
	case "defiance_ivceco_yellow": {770};
	
	case "defiance_avalanche_black": {75};
	case "defiance_avalanche_blue": {75};
	case "defiance_avalanche_grey": {75};
	case "defiance_avalanche_orange": {75};
	case "defiance_avalanche_pink": {75};
	case "defiance_avalanche_purple": {75};
	case "defiance_avalanche_red": {75};
	case "defiance_avalanche_yellow": {75};
	...
	case "A3L_Dumptruck": {200};
	case "cg_mercedes_sprinter_van_white": {150};
	case "cg_mercedes_sprinter_van_rouge": {150};
	case "cg_mercedes_sprinter_van_orange": {150};
	case "cg_man_tgs_tow_reg": {60};
	case "cg_daf_xf_euro6": {60};
	case "cg_daf_xf_euro6_white": {60};
	case "cg_daf_xf_euro6_noir": {60};
	case "cg_daf_xf_euro6_bleufonce": {60};
	case "cg_daf_xf_euro6_vert": {60};
	case "cg_daf_xf_euro6_rouge": {60};
	case "cg_daf_xf_euro6_grise": {60};
	case "cg_daf_xf_euro6_jaune": {60};
	case "cg_daf_xf_euro6_rose": {60};
	case "cg_daf_xf_euro6_violet": {60};
	case "cg_daf_xf_euro6_orange": {60};
	case "cg_renault_magnum_truck_f": {600};
	case "cg_renault_magnum_truck_f_red": {600};
	case "cg_renault_magnum_truck_f_white": {600};
	case "cg_renault_magnum_truck_f_noir": {600};
	case "cg_renault_magnum_truck_f_bleu": {600};
	case "cg_renault_magnum_truck_f_vert": {600};
	case "cg_renault_magnum_truck_f_jaune": {600};
	case "cg_renault_magnum_truck_f_rose": {600};
	case "cg_renault_magnum_truck_f_grise": {600};
	case "cg_renault_magnum_truck_f_violet": {600};
	case "cg_renault_magnum_truck_f_orange": {600};
